    ...
    this.profile.innerHTML = `
      <div class="container border my-4 p-4">
        <div class="row">
          ...
          <div class="col-md-9">
            <span class="badge bg-primary fs-6">Open Repos: ${user.public_repos}</span>
            <span class="badge bg-secondary fs-6">Open Gists: ${user.public_gist}</span>
      ...
      <h3 class="fs-1 m-5">Least Repos</h3>
